...
Hooks.once('init', () => {
    ...
    pf1.config.casterProgression.castsPerDay.spontaneous.low = [
        ...
        [Number.POSITIVE_INFINITY, 5, 5, 4, 4],
        [Number.POSITIVE_INFINITY, 5, 5, 5, 5],
    ];
    ...
    pf1.config.casterProgression.castsPerDay.spontaneous.med = [
        [Number.POSITIVE_INFINITY, 2],
        [Number.POSITIVE_INFINITY, 2],
        [Number.POSITIVE_INFINITY, 3],
        [Number.POSITIVE_INFINITY, 3, 2],
        ...
        [Number.POSITIVE_INFINITY, 5, 4, 3, 2],
        [Number.POSITIVE_INFINITY, 5, 4, 4, 3],
        [Number.POSITIVE_INFINITY, 5, 5, 4, 3, 2],
        [Number.POSITIVE_INFINITY, 5, 5, 4, 3, 3],
        [Number.POSITIVE_INFINITY, 5, 5, 4, 4, 3],
        [Number.POSITIVE_INFINITY, 5, 5, 5, 4, 4, 2],
        [Number.POSITIVE_INFINITY, 5, 5, 5, 4, 4, 3],
        [Number.POSITIVE_INFINITY, 5, 5, 5, 4, 4, 3],
        [Number.POSITIVE_INFINITY, 5, 5, 5, 5, 4, 3],
        [Number.POSITIVE_INFINITY, 5, 5, 5, 5, 4, 4],
